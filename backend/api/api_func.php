...
function saveAvatar($uid, $tmp_name) {

    $filepath = '../../backend/data/user/avatar/';

    if(move_uploaded_file($tmp_name, $filepath.$uid.'.png')){

        $avatar_url = 'https://www.sakuyo.cn/backend/data/user/avatar/'.$uid.'.png';

        if (setUserInfo($uid, '', $avatar_url)) {
